...
class House591Spider():
    ...
    def search(self, filter_params=None, sort_params=None, want_page=1):
        ...
        params = 'type=2&shType=list&regionid=8&price=1250_1500&shape=3&timestamp={ts}'.format(ts = ts)
        ...
        while page < want_page:
            ...
            logging.info('info')
            logging.info(data)
            total_count = len(data['data']['house_list'])
    ...
    def get_house_detail(self, house_id):
        ...
        url = f'https://bff.591.com.tw/v1/house/sale/statis/detail?id={house_id}&kind=9&fromCommunity=0&saletype=0'
